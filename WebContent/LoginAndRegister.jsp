...
<!-- header starts here -->
  ...
  <div >
     <table align="left">
      <tr>
      <td class="input">
         <b style="color: grey;font-size: 15px; font-family: sans-serif;">Help</b>
         <ul class="tooltip">
   			<li>Give us your name !</li>
   			<li>Make sure your E-mail id is valid ! Your E-mail can contain only '_' and/or '.'</li>
   			<li>Your password should be minimum 8 and maximum 20 characters and should contain :
   			  <ol type="1">
  			...
  			<li>Your date of birth cannot be the same as or more than the current date !</li>
  			<li>Make sure to enter your year of passing if you are an ALUMNI!</li>
  			<li>Select your department wisely !</li>
  		 </ul>
