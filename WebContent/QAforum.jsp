...
%>
		...
		<p>Question by : <%=q.log_user_name%> </p>
  			<a id="displayquestion" name="displayquestion" href="GetAnstoQueServlet?question_id=<%= q.question_id %>&logged_user_id=<%=session.getAttribute("user_id")%>&answer_user_name=<%=session.getAttribute("name")%>"><%=q.question_text%>
