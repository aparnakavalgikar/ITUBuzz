...
<td></td>
<td></td>
<td><a href="/jsp/ResetPassword.jsp" >Forgot password?</a></td>
</tr>
</table>
...
<tr>
<td> Not a Memeber ? </td>
<td><u>Sign Up Now</u></td>
<tr>
<td>
<input type="radio" name="register" id="student" onclick="javascript:currentStudentCheck();" value="currentStudent">Current Student
</td>
<td>
...
<tr>
<td>E-mail id* :</td>
<td> <input type="text" name="e_mail_id"value="sample@itu.com" /></td>
</tr>
<tr>
<td>New Password* :</td>
...
<td> <input type="password" name="re_enter_password" /></td>
</tr>
<tr align="left">
<td>Date of Birth :</td>
<td > 
...
<tr>
<td>E-mail id* :</td>
<td> <input type="text" name="e_mail_id"value="sample@example.com" /></td>
</tr>
<tr>
<td>New Password* :</td>
<td> <input type="password" name="new_password" /></td>
...
<tr>
<td>Re-enter Password* :</td>
<td> <input type="password" name="re_enter_password" maxlength="20"/></td>
</tr>
<tr align="left">
<td>Date of Birth :</td>
<td > 
...
<tr>
<td>Departments*  : </td>
<td><select  multiple name="department">
<option  value="Select">--select--</option>
<option  value="Software">MS in Software Engineering</option>
<option  value="Electrical">MS in Computer/Electrical Engineering</option>
<option  value="Digital">MS in Digital Arts</option>
