...
<%
    ...
    if(null!=request.getAttribute("errorMessageEMail"))
    {
    	out.println(request.getAttribute("errorMessageEMail"));	
    }
    
    if(null!=request.getAttribute("errorMessageName"))
    {
    	out.println(request.getAttribute("errorMessageName"));	
    }
    
    if(null!=request.getAttribute("errorMessagePassword1"))
    {
    	out.println(request.getAttribute("errorMessagePassword1"));	
    }
    
    if(null!=request.getAttribute("errorMessagePassword2"))
    {
    	out.println(request.getAttribute("errorMessagePassword2"));	
    }
        ...
        <div id="header-main-right">
          <div id="header-main-right-nav">
            <form id="login_form" action="loginServlet" method="post">
              <table>
                <tr>
                  <td ><input type="text" tabindex="1"  id="email"  name="user_name" class="inputtext" ></td>
                  <td ><input type="password" tabindex="2" id="pass"  name="login_password" class="inputtext" ></td>
...
<input type="radio" name="register" id="faculty" onclick="javascript:currentStudentCheck();" value="faculty">Faculty
    ...
    <div id= "student1" style="display:none"> 
      <table>
        <tr>
          <td>E-mail id* :</td>
            <td> <input type="text" name="e_mail_id_student" value="sample@itu.com" /></td>
        </tr>
        <tr>
          <td>New Password* :</td>
            <td> <input type="password" name="new_password_student" /></td>
        </tr>
        <tr>
          <td>Confirm Password* :</td>
            <td> <input type="password" name="re_enter_password_student" /></td>
        </tr>
        <tr>
          <td>Department* : </td>
          <td><select name="department_student" >
        ...
        <tr>
          ...
          <td><select name="semester_student">
            <option  value="null">--select--</option>
            <option  value="sem1">  Trimester I  </option>
            <option  value="sem2">  Trimester II  </option>
            <option  value="sem2">  Trimester III  </option>
            <option  value="sem2">  Trimester IV  </option>
            </select>
          </td>
        </tr>
            </table>
                <br>
                    <input type="submit" name="submit" onclick="validateRegisterCredentials()" value="Join now" />
        ...
        <div id= "alumni1" style="display:none"> 
          <table>
            <tr>
              <td>E-mail id* :</td>
                <td> <input type="text" name="e_mail_id_alumni" value="sample@example.com" /></td>
            </tr>
            <tr>
              <td>New Password* :</td>
                <td> <input type="password" name="new_password_alumni" /></td>
            </tr>
            <tr>
              <td>Re-enter Password* :</td>
                <td> <input type="password" name="re_enter_password_alumni" /></td>
            </tr>
            <tr>
              <td>Department* : </td>
                <td><select name="department_alumni" >
                  <option  value="null">--select--</option>
                  <option  value="Software">MS in Software Engineering</option>
                  <option  value="Electrical">MS in Computer/Electrical Engineering</option>
                  <option  value="Digital">MS in Digital Arts</option>
...
<option value="1905">1905</option>
        ...
        <br>
          <input type="submit" name="submit" onclick="validateRegisterCredentials()" value="Register" />
            <input type="submit" name="cancel" value="Cancel" />
      ...
      <div id= "faculty1" style="display:none"> 
        <table>
          <tr>
            <td>E-mail id* :</td>
              <td> <input type="text" name="e_mail_id_faculty" value="sample@itu.com" /></td>
          </tr>
          <tr>
            <td>New Password* :</td>
              <td> <input type="password" name="new_password_faculty" /></td>
          </tr>
          <tr>
            <td>Re-enter Password* :</td>
              <td> <input type="password" name="re_enter_password_faculty" /></td>
          </tr>
          <tr>
            <td>Departments*  : </td>
              <td><select  multiple name="department_faculty">
                <option  value="null">--select--</option>
                <option  value="Software">MS in Software Engineering</option>
                <option  value="Electrical">MS in Computer/Electrical Engineering</option>
                <option  value="Digital">MS in Digital Arts</option>
